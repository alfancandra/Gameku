          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span></span>VALORANT</h1>
                  <h2>RIOT GAMES</h2>
                </div>
                <div class="col-sm-6">
                  <img src="images/home/slide-1.jpg" class="girl img-responsive" alt="" />
                </div>
              </div>

              <div class="item">
                <div class="col-sm-6">
                  <h1><span></span>DOTA 2</h1>
                  <h2>VALVE</h2>
                </div>
                <div class="col-sm-6">
                  <img src="images/home/slide-3.jpg" class="girl img-responsive" alt="" />
                </div>
              </div>
              
              <div class="item">
                <div class="col-sm-6">
                  <h1><span></span>POINT BLANK</h1>
                  <h2>ZEPETTO</h2>
                </div>
                <div class="col-sm-6">
                  <img src="images/home/slide-4.jpg" class="girl img-responsive" alt="" />
                </div>
              </div>
