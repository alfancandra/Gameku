...
function doInsert(){
	...
	function doDelete(){
		...
		if($summary->PAYMENTMETHOD=='BANK TRANSFER'){
			redirect(web_root."index.php?q=pembayaran");
		}elseif ($summary->PAYMENTMETHOD=='OVO') {
			redirect(web_root."index.php?q=pembayaran2");
		}
