      ...
      <div class="table-responsive cart_info"> 
              ...
              <table class="table table-condensed" id="table">
                ...
                <tr class="cart_menu"> 
                  ...
                  <th style="width:15%; align:center; ">ID ACCOUNT</th>
      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="BANK TRANSFER" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >BANK TRANSFER 
                        
                      </label>
                  </div> 
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="OVO" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >OVO
